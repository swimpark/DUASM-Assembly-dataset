"""
Assembly-level graph autoencoder training script (DUASM, Case 3).

File location:
    JMS_Code/Assembly_AE/Case3/DUASM/Case3_DUASM_train.py
...
CURRENT_DIR = Path(__file__).resolve().parent          # .../Case3/DUASM
CASE_DIR = CURRENT_DIR.parent                          # .../Case3
...
# Input CSVs are shared at the Case3 level
DATA_DIR = CASE_DIR
...
if __name__ == "__main__":
    assembly_metrics_file = SAVE_DIR / "train_assembly_metrics.csv"
    embedding_file = DATA_DIR / "CAE_train_extracted_embeddings.csv"
    edge_file = SAVE_DIR / "train_assembly_edges.csv"
