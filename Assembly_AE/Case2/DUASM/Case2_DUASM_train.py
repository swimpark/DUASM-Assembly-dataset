"""
Assembly-level graph autoencoder training script (DUASM, Case 2).

File location:
    JMS_Code/Assembly_AE/Case2/DUASM/Case2_DUASM_train.py
...
CURRENT_DIR = Path(__file__).resolve().parent          # .../Case2/DUASM
CASE_DIR = CURRENT_DIR.parent                          # .../Case2
...
# Input CSVs are shared at the Case2 level
DATA_DIR = CASE_DIR
